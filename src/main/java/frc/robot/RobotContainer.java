...
import frc.robot.commands.MudulaMotorComand;
...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    return new SequentialCommandGroup(new MudulaMotorComand(subsystem, 90, 0),
        new MudulaMotorComand(subsystem, 135, 1),
        new MudulaMotorComand(subsystem, 0, -1));
  }
}
