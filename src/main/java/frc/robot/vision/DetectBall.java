...
public class DetectBall {
    public static void main(String[] args) {
        ...
        // Convert the image to HSV color space and threshold it to isolate the yellow
        // color of the ball
        Mat hsv = new Mat();
        ...
        // Find the best contour based on area and aspect ratio, and draw a bounding
        // rectangle and center point on the output image
        ...
        // Draw the best contour and its bounding rectangle and center point on the
        // output image
        if (bestRect != null) {
