...
public final class Constants {
    ...
    public static class ChassisConstants {
        ...
        public static final CancoderConfig CANCODER_FRONT_RIGHT_CONFIG = new CancoderConfig(CANCODER_FRONT_RIGHT_ID,
                CANBUS,
        ...
        public static final CancoderConfig CANCODER_FRONT_LEFT_CONFIG = new CancoderConfig(CANCODER_FRONT_LEFT_ID,
                CANBUS,
                CANCODER_NAME); // cancoder
        ...
        public static final CancoderConfig CANCODER_BACK_RIGHT_CONFIG = new CancoderConfig(CANCODER_BACK_RIGHT_ID,
                CANBUS,
                CANCODER_NAME); // cancoder
