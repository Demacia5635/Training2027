...
public final class Constants {
  ...
  public static final TalonFXConfig CONFIG_STEER_FRONT_LEFT = new TalonFXConfig(STEER_MOTOR_ID_FRONT_LEFT, CANBUS, STEER_MOTOR_NAME_FRONT_LEFT)
      .withPID(KP_STEER, KI_STEER, KD_STEER, KS_STEER, KV_STEER, KA_STEER, KG_STEER)
      .withRadiansMotor(GEAR_RATIO_STEER);
  public static final TalonFXConfig CONFIG_DRIVE_FRONT_LEFT = new TalonFXConfig(DRIVE_MOTOR_ID_FRONT_LEFT, CANBUS, DRIVE_MOTOR_NAME_FRONT_LEFT)
      .withPID(KP_Drive, KI_Drive, KD_Drive, KS_DRIVE, KV_DRIVE, KA_DRIVE, KG_DRIVE)
      .withMeterMotor(GEAR_RATIO_DRIVE,SCOPE);
  public static CancoderConfig CONFIG_CANCODER_FRONT_LEFT = new CancoderConfig(CANCODER_ID_FRONT_LEFT, CANBUS, CANCODER_NAME_FRONT_LEFT);
  
  public static final TalonFXConfig CONFIG_STEER_FRONT_RIGHT = new TalonFXConfig(STEER_MOTOR_ID_FRONT_RIGHT, CANBUS, STEER_MOTOR_NAME_FRONT_LEFT)
      .withPID(KP_STEER, KI_STEER, KD_STEER, KS_STEER, KV_STEER, KA_STEER, KG_STEER)
      .withRadiansMotor(GEAR_RATIO_STEER);
  public static final TalonFXConfig CONFIG_DRIVE_FRONT_RIGHT = new TalonFXConfig(DRIVE_MOTOR_ID_FRONT_RIGHT, CANBUS, DRIVE_MOTOR_NAME_FRONT_RIGHT)
      .withPID(KP_Drive, KI_Drive, KD_Drive, KS_DRIVE, KV_DRIVE, KA_DRIVE, KG_DRIVE)
      .withMeterMotor(GEAR_RATIO_DRIVE,SCOPE);
      public static CancoderConfig CONFIG_CANCODER_FRONT_RIGHT = new CancoderConfig(CANCODER_ID_FRONT_RIGHT, CANBUS, CANCODER_NAME_FRONT_RIGHT);
      
  public static final TalonFXConfig CONFIG_STEER_BACK_LEFT = new TalonFXConfig(STEER_MOTOR_ID_BACK_LEFT, CANBUS, STEER_MOTOR_NAME_BACK_LEFT)
      .withPID(KP_STEER, KI_STEER, KD_STEER, KS_STEER, KV_STEER, KA_STEER, KG_STEER)
      .withRadiansMotor(GEAR_RATIO_STEER);
  public static final TalonFXConfig CONFIG_DRIVE_BACK_LEFT = new TalonFXConfig(DRIVE_MOTOR_ID_BACK_LEFT, CANBUS, DRIVE_MOTOR_NAME_BACK_LEFT)
      .withPID(KP_Drive, KI_Drive, KD_Drive, KS_DRIVE, KV_DRIVE, KA_DRIVE, KG_DRIVE)
      .withMeterMotor(GEAR_RATIO_DRIVE,SCOPE);
  public static CancoderConfig CONFIG_CANCODER_BACK_LEFT = new CancoderConfig(CANCODER_ID_BACK_LEFT, CANBUS, CANCODER_NAME_BACK_LEFT);
  
  public static final TalonFXConfig CONFIG_STEER_BACK_RIGHT = new TalonFXConfig(STEER_MOTOR_ID_BACK_RIGHT, CANBUS, STEER_MOTOR_NAME_BACK_LEFT)
      .withPID(KP_STEER, KI_STEER, KD_STEER, KS_STEER, KV_STEER, KA_STEER, KG_STEER)
      .withRadiansMotor(GEAR_RATIO_STEER);
  public static final TalonFXConfig CONFIG_DRIVE_BACK_RIGHT = new TalonFXConfig(DRIVE_MOTOR_ID_BACK_RIGHT, CANBUS, DRIVE_MOTOR_NAME_BACK_RIGHT)
      .withPID(KP_Drive, KI_Drive, KD_Drive, KS_DRIVE, KV_DRIVE, KA_DRIVE, KG_DRIVE)
      .withMeterMotor(GEAR_RATIO_DRIVE,SCOPE);
      public static CancoderConfig CONFIG_CANCODER_BACK_RIGHT = new CancoderConfig(CANCODER_ID_BACK_RIGHT, CANBUS, CANCODER_NAME_BACK_RIGHT);
