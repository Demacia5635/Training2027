...
public class Utils {
  ...
  // return RobotContainer.robotContainer.isRed()? Field.RedSpeaker:
  // Field.Speaker;
  // }
  // public static Translation2d speakerTargetPosition() {
  // return RobotContainer.robotContainer.isRed()? Field.RedSpeakerTarget:
  // Field.SpeakerTarget;
  // }
  ...
  // return RobotContainer.robotContainer.isRed()? Field.RedSubShootPosition:
